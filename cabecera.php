...
class cabecera extends elemento{
	...
	private $menu=array(
			"Inicio"=>array(
					"txt"=>"Inicio",
					//"url"=>"http://169.254.154.238/Proyecto03/index.php"
					"url"=>"http://192.168.1.22/Proyecto03/index.php"
									
				),
			"Fotos"=>array(
					"txt"=>"Fotos",
					//"url"=>"http://169.254.154.238/Proyecto03/fotos.php"
					"url"=>"http://192.168.1.22/Proyecto03/fotos.php"					
				),
			"Contacto"=>array(
					"txt"=>"Contacto",
					//"url"=>"http://169.254.154.238/Proyecto03/contacto.php"
